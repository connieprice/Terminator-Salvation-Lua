Menu2DFadeInAnimation = Menu2DFadeInAnimation or class({})
function Menu2DFadeInAnimation.init(A0_0, A1_1, A2_2, A3_3, A4_4)
	A0_0._object = A1_1
	A0_0._fade_speed = A3_3
	A0_0._wait_time = A2_2 or 0
	A0_0._start_alpha = A1_1:color().alpha
	A0_0._end_alpha = A4_4
	A0_0._alpha_diff = A4_4 - A0_0._start_alpha
	A0_0._fade_speed_timer = 0
	A0_0._wait_timer = 0
end
function Menu2DFadeInAnimation.update(A0_5, A1_6)
	local L2_7, L3_8
	...
	L3_8 = A0_5._alpha_diff
	L3_8 = L2_7 * L3_8
	L3_8 = L3_8 + A0_5._start_alpha
